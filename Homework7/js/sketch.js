...
function preload()
{
  haunted = loadImage("assets/hauntedHouse.jpeg");
}
...
function draw() 
{
  ...
  text('Press Spacebar to initialize audio!', 415, 415);
  ...
  //text('Press Spacebar to initialize audio!', 200, 100);
  text('Press mouse/keypad to continue audio!', 175, 125);
}
