...
let spriteSheetFilenames = ["Butterfly.png"];
let spriteSheets = [];
let animations = [];
...
function reset() 
{
  ...
  {
    animations[i] = new WalkingAnimation(random(spriteSheets), 64, 64, random(100,500), random(100,500), 6, random(1,5), 6, random([0,1]));
  }
}
...
function draw() 
{
  switch(game.state) 
  {
    ...
    case GameState.GameOver:
      ...
      text("Press Any Key to Restart!", 300, 420);
      break;
    ...
    case GameState.Start:
      ...
      textSize(35);
      textAlign(CENTER);
      text("Butterfly Squish Game", 300, 300);
      textSize(25);
